...
#ifndef FLATBUFFERS_GENERATED_USEREVENT_USEREVENT_H_
#define FLATBUFFERS_GENERATED_USEREVENT_USEREVENT_H_
...
template<> struct EventTypeTraits<UserEvent::C2S_Login> {
  static const EventType enum_value = EventType_C2S_Login;
};

template<> struct EventTypeTraits<UserEvent::S2C_Login> {
  static const EventType enum_value = EventType_S2C_Login;
};

template<> struct EventTypeTraits<UserEvent::C2S_PlayerMoveData> {
  static const EventType enum_value = EventType_C2S_PlayerMoveData;
};

template<> struct EventTypeTraits<UserEvent::S2C_PlayerMoveData> {
  static const EventType enum_value = EventType_S2C_PlayerMoveData;
};

template<> struct EventTypeTraits<UserEvent::C2S_Logout> {
  static const EventType enum_value = EventType_C2S_Logout;
};

template<> struct EventTypeTraits<UserEvent::S2C_Logout> {
...
inline ::flatbuffers::Offset<C2S_Login> CreateC2S_LoginDirect(
  ...
  return UserEvent::CreateC2S_Login(
      _fbb,
      userid__,
      password__);
}
...
struct S2C_Login FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const UserEvent::Color *color() const {
    return GetStruct<const UserEvent::Color *>(VT_COLOR);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<UserEvent::Color>(verifier, VT_COLOR, 1) &&
           verifier.EndTable();
  }
};
...
struct S2C_LoginBuilder {
  ...
  void add_color(const UserEvent::Color *color) {
...
inline ::flatbuffers::Offset<S2C_Login> CreateS2C_Login(
    ...
    const UserEvent::Color *color = nullptr) {
...
inline ::flatbuffers::Offset<S2C_Login> CreateS2C_LoginDirect(
  ...
  return UserEvent::CreateS2C_Login(
      _fbb,
      success,
      message__,
      position_x,
...
struct C2S_LogoutBuilder {
  ...
  void add_userid(uint32_t userid) {
    fbb_.AddElement<uint32_t>(C2S_Logout::VT_USERID, userid, 0);
  }
...
inline ::flatbuffers::Offset<S2C_Logout> CreateS2C_LogoutDirect(
    ...
    const char *message = nullptr) {
  auto message__ = message ? _fbb.CreateString(message) : 0;
  return UserEvent::CreateS2C_Logout(
      _fbb,
      player_id,
      success,
      message__);
...
struct EventData FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  UserEvent::EventType data_type() const {
    return static_cast<UserEvent::EventType>(GetField<uint8_t>(VT_DATA_TYPE, 0));
  }
  const void *data() const {
    return GetPointer<const void *>(VT_DATA);
  }
  template<typename T> const T *data_as() const;
  const UserEvent::C2S_Login *data_as_C2S_Login() const {
    return data_type() == UserEvent::EventType_C2S_Login ? static_cast<const UserEvent::C2S_Login *>(data()) : nullptr;
  }
  const UserEvent::S2C_Login *data_as_S2C_Login() const {
    return data_type() == UserEvent::EventType_S2C_Login ? static_cast<const UserEvent::S2C_Login *>(data()) : nullptr;
  }
  const UserEvent::C2S_PlayerMoveData *data_as_C2S_PlayerMoveData() const {
    return data_type() == UserEvent::EventType_C2S_PlayerMoveData ? static_cast<const UserEvent::C2S_PlayerMoveData *>(data()) : nullptr;
  }
  const UserEvent::S2C_PlayerMoveData *data_as_S2C_PlayerMoveData() const {
    return data_type() == UserEvent::EventType_S2C_PlayerMoveData ? static_cast<const UserEvent::S2C_PlayerMoveData *>(data()) : nullptr;
  }
  const UserEvent::C2S_Logout *data_as_C2S_Logout() const {
    return data_type() == UserEvent::EventType_C2S_Logout ? static_cast<const UserEvent::C2S_Logout *>(data()) : nullptr;
  }
  const UserEvent::S2C_Logout *data_as_S2C_Logout() const {
    return data_type() == UserEvent::EventType_S2C_Logout ? static_cast<const UserEvent::S2C_Logout *>(data()) : nullptr;
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
template<> inline const UserEvent::C2S_Login *EventData::data_as<UserEvent::C2S_Login>() const {
  return data_as_C2S_Login();
}

template<> inline const UserEvent::S2C_Login *EventData::data_as<UserEvent::S2C_Login>() const {
  return data_as_S2C_Login();
}

template<> inline const UserEvent::C2S_PlayerMoveData *EventData::data_as<UserEvent::C2S_PlayerMoveData>() const {
  return data_as_C2S_PlayerMoveData();
}

template<> inline const UserEvent::S2C_PlayerMoveData *EventData::data_as<UserEvent::S2C_PlayerMoveData>() const {
  return data_as_S2C_PlayerMoveData();
}

template<> inline const UserEvent::C2S_Logout *EventData::data_as<UserEvent::C2S_Logout>() const {
  return data_as_C2S_Logout();
}

template<> inline const UserEvent::S2C_Logout *EventData::data_as<UserEvent::S2C_Logout>() const {
...
struct EventDataBuilder {
  ...
  void add_data_type(UserEvent::EventType data_type) {
...
inline ::flatbuffers::Offset<EventData> CreateEventData(
    ...
    UserEvent::EventType data_type = UserEvent::EventType_NONE,
...
inline bool VerifyEventType(::flatbuffers::Verifier &verifier, const void *obj, EventType type) {
  switch (type) {
    ...
    case EventType_C2S_Login: {
      auto ptr = reinterpret_cast<const UserEvent::C2S_Login *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case EventType_S2C_Login: {
      auto ptr = reinterpret_cast<const UserEvent::S2C_Login *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case EventType_C2S_PlayerMoveData: {
      auto ptr = reinterpret_cast<const UserEvent::C2S_PlayerMoveData *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case EventType_S2C_PlayerMoveData: {
      auto ptr = reinterpret_cast<const UserEvent::S2C_PlayerMoveData *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case EventType_C2S_Logout: {
      auto ptr = reinterpret_cast<const UserEvent::C2S_Logout *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case EventType_S2C_Logout: {
      auto ptr = reinterpret_cast<const UserEvent::S2C_Logout *>(obj);
      return verifier.VerifyTable(ptr);
    }
    default: return true;
  }
...
inline const UserEvent::EventData *GetEventData(const void *buf) {
  return ::flatbuffers::GetRoot<UserEvent::EventData>(buf);
}

inline const UserEvent::EventData *GetSizePrefixedEventData(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<UserEvent::EventData>(buf);
}

inline bool VerifyEventDataBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<UserEvent::EventData>(nullptr);
}

inline bool VerifySizePrefixedEventDataBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<UserEvent::EventData>(nullptr);
}

inline void FinishEventDataBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<UserEvent::EventData> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_USEREVENT_USEREVENT_H_
